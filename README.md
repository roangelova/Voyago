...
<img width="1714" height="1219" alt="image" src="https://github.com/user-attachments/assets/dacb30dc-4a36-47ea-adb0-1f77e973d710" />
...
- Backend: .NET
  ...
  Additional: Axios, TanStack Query, react-leaflet, Hangfire 
...
#### Supported features (as of Jan 2026)
  1. User Management
...
- Update passenger data (add, edit, delete passengers). Manage account ownership.

 2. Trip Search
- Search for trips based on departure/arrival destination, start/end date. Also possible to choose type (adult, child or infant) and count of passengers for each search.
- View trip journey on a map
...
Initial project start date: Jan 2025
